...
class AbcdFormat(DatasetSpec):
    ...
    class AbcdProperties(DatasetProperties):
    ...
    class AbcdFormatCode(ComponentCode):
        def __init__(self, props):
            self.props: AbcdFormat.AbcdProperties = props
